...
import { DraftRepository, PreferencesRepository } from '../../src/server/db/repositories/conversation.repository.js';
import { DraftPreferencesService } from '../../src/server/services/draft-preferences-service.js';
import { ConflictError, InvalidRequestError } from '../../src/server/domain/errors.js';
...
describe('Phase 3: Draft and Preferences Service', () => {
  ...
  describe('Draft Management', () => {
    ...
    it('should reject draft exceeding max input byte size', () => {
      const largeContent = 'a'.repeat(LIMITS.USER_INPUT_MAX_BYTES + 1);
      expect(() => {
