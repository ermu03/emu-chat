  ...
  return (
    <div className="flex flex-col border-b border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900 text-xs">
      {status?.lan_http_warning && (
        ...
        >
          <span>
            当前处于局域网非安全 HTTP 环境，PWA 离线存储与后台通知已受限。建议配置 HTTPS 反向代理。
          </span>
      ...
      <div className="flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center space-x-2">
          {typeof status?.active_runs_count === 'number' && status.active_runs_count > 0 && (
            <span className="px-2 py-0.5 bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-full font-medium">
              运行中: {status.active_runs_count}
            </span>
          )}
